    ...
    return (
        <>
            ...
            <Grid mb={1} sx={{ borderBottom: "1px solid #ddd", marginBottom: "8px", paddingBottom: "8px" }}>
                <label>ราคา</label>
                <input type="number" value={editedPrice} placeholder="ระบุราคา" onChange={(e) => setEditedPrice(e.target.value)} />
            </Grid>
            ...
            <Grid item xs={12} display="flex" justifyContent="center" alignItems="center" marginBottom="8px" onClick={handleAddMoreFields}>
                <AddCircleIcon sx={{ color: "#62c965", cursor: "pointer", fontSize: "30px" }} />
                <p style={{ marginLeft: "4px", cursor: "pointer"}}>เพิ่มวัตถุดิบ</p>
            </Grid>
