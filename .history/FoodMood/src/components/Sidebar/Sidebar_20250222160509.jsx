...
const Sidebar = ({ unreadNotifications }) => {
    ...
    return (
        <>
            ...
            >
                <Box p={2} sx={{ height: '100vh', display: 'flex', flexDirection: 'column', alignItems: isCollapsed ? 'center' : 'flex-start', boxShadow: '2px 0 5px rgba(0, 0, 0, 0.1)' }}>
                    ...
                    {/* Logout button */}
                    <Button
                        sx={{display: 'left', width:"100%", alignItems: 'center', padding: '10px 16px', borderRadius: '26px', backgroundColor:"#ff7878", color: '#fff', transition: '0.3s'}}
