        ...
        <>
            ...
            >
                <Box p={2} sx={{ height: '100vh', display: 'flex', flexDirection: 'column', alignItems: isCollapsed ? 'center' : 'flex-start', }}>
                    ...
                    {/* Logout button */}
                    <Button 
                        sx={{display: 'flex', alignItems: 'center', borderRadius: '26px', backgroundColor:"#ff4b4b", color: '#fff'}}
                        onMouseEnter={(e) => { e.currentTarget.style.backgroundColor = '#ff7878'; e.currentTarget.style.color = '#fff'; }}
                        onMouseLeave={(e) => { e.currentTarget.style.backgroundColor = '#ff4b4b'; e.currentTarget.style.color = '#fff';}}
                    >
