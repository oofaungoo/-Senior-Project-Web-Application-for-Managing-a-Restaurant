...
import { Box, Button, Drawer, IconButton, useMediaQuery, Typography } from '@mui/material';
    ...
    return (
        <>
            ...
            {isSmallScreen && (
                ...
                >
                    <MenuRoundedIcon />
                    <Typography sx={{ marginLeft: 1, fontSize: '16px' }}>เมนู</Typography> {/* ✅ เพิ่มข้อความ */}
                </IconButton>
            )}
                            ...
                            <Link to={item.to} key={item.label}>
                                ...
                                >
                                    ...
                                    <span
                                        style={{
                                            marginLeft: 10,
                                            maxWidth: isCollapsed ? 0 : 120,  // ปรับขนาดสูงสุดของ text
                                            overflow: 'hidden',
                                            whiteSpace: 'nowrap',
                                            opacity: isCollapsed ? 0 : 1,   // ค่อยๆ หายไป
                                            transition: 'max-width 0.3s, opacity 0.3s', // ให้มี transition
                                        }}
                                    >
                                        {item.label}
                                    </span>
                    ...
                    <Box sx={{ marginTop: 'auto', width: '100%' }}> {/* ✅ ทำให้ปุ่มติดด้านล่าง */}
                        ...
                        >
                            ...
                            <p
                                style={{
                                    marginLeft: '10px',
                                    maxWidth: isCollapsed ? 0 : 100, // ค่อยๆ หดตัว
                                    overflow: 'hidden',
                                    whiteSpace: 'nowrap',
                                    opacity: isCollapsed ? 0 : 1,   // ค่อยๆ จางลง
