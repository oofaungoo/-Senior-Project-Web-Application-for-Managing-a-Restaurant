...
const MenuManager = () => {
    ...
    return (
        <>
            <Box sx={{ backgroundColor: "#fff", maxWidth: "75%", height: "100vh", padding: "20px", borderRadius: "8px", overflowY: "auto", marginRight: "10px" }}>
                <MenuList
                    data={data}
                    category={category}
            ...
            {/* Desktop Mode: แสดง AddMenu และ MenuItemDetail ด้วย Box โดยจะอย๔ู่ทางด้านขวามือ */}
            {!isMobile && (showEditData||showItemDetail) && (
                <Box sx={{ backgroundColor: "#fff", width:"50%", height: "100vh", padding: "20px", borderRadius: "8px", overflowY: "auto", display: "flex", flexDirection: "column"}}>
                    {showEditData && (
                        <AddNewMenu
