...
const MenuList = ({ data = [], category = [], onMenuClick, onAddNewMenu, selectedItem }) => {
    ...
    return (
        <Grid spacing={0} style={{ backgroundColor: "#fff", width: "75%", height: "100vh", padding: "20px", borderRadius: "8px", overflowY: "auto" }}>
            <Grid container spacing={1} style={{ marginBottom: 10 }}>
                <TextField id="outlined-basic" label="ค้นหาเมนู" variant="outlined" sx={{ fontFamily: "IBM Plex Sans Thai" }} value={searchQuery} onChange={(e) => setSearchQuery(e.target.value)} />
