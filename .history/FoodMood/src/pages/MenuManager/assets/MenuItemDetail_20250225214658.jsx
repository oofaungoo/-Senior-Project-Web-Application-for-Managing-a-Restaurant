...
const MenuItemDetail = ({ selectedItem, onEdit, handleClickConfirm, onClose }) => {
    ...
    return (
        <Stack sx={{ minHeight: "100%", display: "flex" }}>
            ...
            <Grid sx={{flexGrow:1}}>
                {/* 1. Image */}
                <img src={selectedItem.image || Food} alt={selectedItem.name} style={{borderRadius: 5, width: "100%", }}/>
            ...
            {/* Action Buttons */}
            <Grid display="flex" justifyContent="space-between" borderTop="1px solid #ddd" sx={{ marginTop: "auto", paddingTop: "8px 0" }}>
