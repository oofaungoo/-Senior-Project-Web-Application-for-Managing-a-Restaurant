...
const MenuList = ({ data = [], category = [], onMenuClick, onAddNewMenu, selectedItem }) => {
    ...
    return (
        <Grid2 spacing={0} style={{backgroundColor:"#fff",width: "75%",height: "100vh",padding: "20px",borderRadius: "8px",overflowY:"auto",fontFamily:"inherit"}}>
            <Grid2 container>
                <TextField id="outlined-basic" label="ค้นหาเมนู" variant="outlined" style={{}}/>
            </Grid2>
