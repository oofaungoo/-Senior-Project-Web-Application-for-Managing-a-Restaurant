        ...
        <>
            ...
            <Grid container spacing={1}>
                ...
                {filteredMenuItems.map((item) => (
                    <Grid item xs={4} md={4} lg={2} key={item._id} minHeight={200} onClick={() => onMenuClick(item)}>
                            ...
                            <Button style={{ height: "100%", padding: 0, margin: 0, display: "flex", flexDirection: "column" }}>
                                <Grid container direction="column" style={{ height: "100%"}}>
                                    <img
                                        ...
                                        alt={item.name}
                                    />
                                    <p style={{ fontSize: 18, fontWeight: 4, color: '#000000',textAlign: "left" }}>{item.name}</p>
                                    <p style={{ fontSize: 15, fontWeight: 4, color: '#777777',textAlign: "left"}}>{item.sizePrices.map((size) => size.size).join("/")}</p>
                                </Grid>
                            </Button>
                        </Paper>
                    </Grid>
