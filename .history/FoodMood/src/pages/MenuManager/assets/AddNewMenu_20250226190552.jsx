                            ...
                            <div>
                                {customOptions.map((item, index) => (
                                    <Box key={index} sx={{ border: "1px solid #ddd", borderRadius: "20px", padding: "8px 13px" }}>
                                        ...
                                        <EditIcon style={{ color: "#ff7878",cursor: 'pointer', marginLeft: '10px' }} onClick={() => handleEditOption(index)}/>
                                        <DeleteForeverIcon style={{ color: "#64A2FF",cursor: 'pointer', marginLeft: '10px' }} onClick={() => handleDeleteOption(index)}/>
                                    </Box>
