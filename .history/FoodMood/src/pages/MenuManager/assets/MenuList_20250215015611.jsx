        ...
        <div className="middle-box">
            ...
            <div className="menu-list">
                ...
                <Grid container spacing={1} >
                    <Grid item xs={6} md={4} lg={2} height={180} >
                    ...
                    {filteredMenuItems.map((item) => (
                        <Grid item xs={6} md={4} lg={2} key={item._id} height={180} onClick={() => onMenuClick(item)} >
                                ...
                                <Button style={{height:"100%",padding:0,margin:0,display:"flex"}} >
                                    <Grid container  direction="column" style={{padding:10,height:"100%"}}>
                                        ...
                                        <p style={{fontSize:13,color:'black'}}>{item.name}</p>
