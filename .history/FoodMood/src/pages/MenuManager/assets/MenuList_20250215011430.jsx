                ...
                <Grid container spacing={1}>
                    <Grid item xs={6} md={4} lg={2} onClick={onAddNewMenu}>
                        <Paper elevation={2} style={{height:"100%"}}>
                            <Grid container justifyContent={"center"} direction="column" textAlign={'center'} style={{paddingTop:"50%",paddingBottom:"50%"}}  >
                        ...
                        <Grid item xs={6} md={4} lg={2} key={item._id} onClick={() => onMenuClick(item)} >
                            <Paper elevation={2} style={{height:"100%"}} >
                                <Grid container style={{padding:10}}>
                                    ...
                                    <p>{item.name}</p>
                                    <p>{item.sizePrices.map(size => size.size).join('/')}</p>
                                </Grid>
                            </Paper>
                        </Grid>
                    ))}
