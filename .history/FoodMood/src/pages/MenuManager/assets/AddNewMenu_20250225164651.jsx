...
const AddNewMenu = ({ form, dataToEdit, onCancel, setShowItemDetail }) => {
    ...
    const [imagePreview, setImagePreview] = useState(dataToEdit?.image || null);
    ...
    const handleSave = () => {
        const menuData = {
            ...
            image: imageUrl, // ใช้ URL ที่ผู้ใช้กรอก
            sizePrices,
            customOptions,
        };
    
        console.log("Data to save:", menuData); // ดูข้อมูลก่อนส่งไปยัง backend
