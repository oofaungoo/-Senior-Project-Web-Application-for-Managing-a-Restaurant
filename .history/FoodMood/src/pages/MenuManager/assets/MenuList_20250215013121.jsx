                ...
                <Grid container spacing={1}>
                    <Grid item xs={6} md={4} lg={2}>
                        <Paper elevation={2} style={{height:"100%",display:"flex",justifyContent:"center",backgroundColor:"#B2B2B2"}} >
                            <Button style={{height:"100%",width:"100%",padding:0,margin:0,display:"flex"}} >
                        ...
                        <Grid item xs={6} md={4} lg={2} key={item._id} onClick={() => onMenuClick(item)} >
                                ...
                                <Button style={{height:"100%",padding:0,margin:0,display:"flex"}} >
                                    <Grid container  direction="column" style={{padding:10,height:"100%"}}>
                                        ...
                                        <p style={{fontSize:13,color:'black',display:"flex", justifyContent:"flex-start"}}>{item.name}</p>
                                        <p style={{fontSize:13,color:'#777777',display:"flex", justifyContent:"flex-start"}}>{item.sizePrices.map(size => size.size).join('/')}</p>
                                    </Grid>
                                </Button>
                                </Paper>
                        </Grid>
