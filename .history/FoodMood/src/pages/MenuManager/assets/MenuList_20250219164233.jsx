...
const MenuList = ({ data = [], category = [], onMenuClick, onAddNewMenu, selectedItem }) => {
    ...
    return (
        <Grid2 spacing={0} style={{ backgroundColor: "#fff", width: "75%", height: "100vh", padding: "20px", borderRadius: "8px", overflowY: "auto" }}>
            ...
            <TextField id="outlined-basic" label="ค้นหาเมนู" variant="outlined" sx={{ fontFamily: "inherit" }} value={searchQuery} onChange={(e) => setSearchQuery(e.target.value)} />
            ...
            <Grid2 container spacing={1} >
                <Grid2 item xs={6} md={4} lg={2} minHeight={200} >
                ...
                {filteredMenuItems.map((item) => (
                    <Grid2 item xs={5} md={4} lg={2} key={item._id} minHeight={200} onClick={() => onMenuClick(item)} >
