                            ...
                            <Grid container marginBottom={"10px"}>
                                {sizePrices.map((item, index) => (
                                    <Grid item xs="auto" key={index}>
                                        <Box sx={{ border: "1px solid #ddd", borderRadius: "20px", padding: "8px 13px" }}>
                                            {item.size} : {item.price} ฿
                                            <EditIcon fontSize="small" cursor="pointer" onClick={() => handleIngredientScreen(item.size, item.price, item.ingredients)} />
                                        </Box>
                                    </Grid>
                                ))}
                            </Grid>
                        ...
                        <Grid>
                            <div>
                                {customOptions.map((item, index) => (
                                    <Box key={index} sx={{ border: "1px solid #ddd", borderRadius: "20px", padding: "8px 13px" }}>
                            ...
                            <Grid container>
                                ...
                                <AddCircleIcon type="button" className="circle-plus-btn" onClick={() => setIsOptionVisible(!isOptionVisible)} />
                                {isOptionVisible && (
                                    <Grid>
                                        <input
                                            type="text"
                                        ...
                                        />
                                        <Grid>
                                            <button type="button" className="blue-button" style={{ marginBottom: "8px" }} onClick={handleAddOption}>
                                                เพิ่มตัวเลือก
                                            </button>
                                        </Grid>
