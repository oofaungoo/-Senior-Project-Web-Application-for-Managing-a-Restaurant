        ...
        <>
            ...
            <Grid container spacing={1}>
                ...
                <Grid item xs={6} md={4} lg={2} minHeight={200}>
                    <Paper elevation={2} style={{ height: "100%", display: "flex", flexDirection: "column", justifyContent: "center", alignItems: "center", backgroundColor: "#B2B2B2" }}>
                        <Button style={{ height: "100%", width: "100%", padding: 0, margin: 0, display: "flex", flexDirection: "column", justifyContent: "center", alignItems: "center" }} onClick={() => onAddNewMenu()}>
                            ...
                            <p style={{ justifyContent: "center", color: "#fff" }}>เพิ่มเมนูใหม่</p>
                        </Button>
                    </Paper>
                </Grid>
                ...
                {filteredMenuItems.map((item) => (
                    <Grid item xs={6} md={4} lg={2} key={item._id} minHeight={200}>
                        <Paper elevation={2} style={{ height: "100%", display: "flex", flexDirection: "column" }}>
                            <Button style={{ height: "100%", width: "100%", padding: 0, margin: 0, display: "flex", flexDirection: "column", alignItems: "flex-start" }}>
                                <Grid container direction="column" style={{ flexGrow: 1, padding: "10px", height: "100%" }}>
                                    <img
                                        style={{ borderRadius: 5, marginBottom: 10, width: "100%", height: "50%", objectFit: "cover" }}
                                        src={item.image || Food}
                                        alt={item.name}
                                    />
                                    <p style={{ fontSize: 18, fontWeight: 4, color: '#000000', textAlign: "left", padding: "0 10px" }}>{item.name}</p>
