            ...
            {!ingredientScreen ? (
                <Stack sx={{ minHeight: "100%", display: "flex" }} onSubmit={(e) => e.preventDefault()}>
                    ...
                    <Grid sx={{ flexGrow: 1 }}>
                        ...
                        {/* 3. Image url upload */}
                        <Grid direction="column" className="upload-img" style={{ marginTop: "10px", paddingBottom:"150px", marginBottom: "8px", borderBottom:"1px solid #ddd", cursor: "pointer" }} onClick={handleImageUpload}>
                            {imageUrl ? (
