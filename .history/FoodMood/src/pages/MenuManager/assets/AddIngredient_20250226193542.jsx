            ...
            <Grid container mb={1}>
                ...
                {ingredients.map((ingredient, index) => (
                    <Grid container spacing={1} key={index} alignItems="center" mb={1}>
                        <Box>
                            <Grid item xs={5} md={5}>
                                <select value={ingredient.newIngredient} onChange={(e) => updateIngredientField(index, "newIngredient", e.target.value)}>
                            ...
                            <Grid item xs={4} md={4}>
                                <input type="number" placeholder="ปริมาณ" value={ingredient.newIngredientQty} onChange={(e) => updateIngredientField(index, "newIngredientQty", e.target.value)} />
                            </Grid>
