                                ...
                                {sizePrices.map((item, index) => (
                                    <Grid container xs="auto" key={index}>
                                        <Box sx={{ border: "1px solid #ddd", borderRadius: "20px", padding: "8px 13px" }}>
                                            ...
                                            <Grid xs={1} >
                                                <EditIcon sx={{color:"#64A2FF"}} cursor="pointer" onClick={() => handleIngredientScreen(item.size, item.price, item.ingredients)} />
                                            </Grid>
                                            <Grid xs={1} >
                                                <DeleteForeverIcon sx={{color:"#ff7878"}} cursor="pointer" onClick={()}/>
                                            </Grid>
                                        </Box>
                                    </Grid>
                                ))}
