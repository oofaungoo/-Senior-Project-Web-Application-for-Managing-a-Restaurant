    ...
    return (
        <>
            ...
            <Box
                sx={{
                    backgroundColor: "#fff",
                    width: isMobile ? "100%" : isTablet ? "70%" : "75%",
                    height: "100vh",
                    padding: "20px",
                    borderRadius: "8px",
                    overflowY: "auto",
            ...
            {/* Desktop & Tablet Mode: แสดง AddMenu และ MenuItemDetail ด้านขวา */}
            {!isMobile && (showEditData || showItemDetail) && (
                <Box
                    sx={{
                        backgroundColor: "#fff",
                        width: isTablet ? "30%" : "25%", // Box ของ Tablet = 30%, Desktop = 25%
                        height: "100vh",
                        padding: "20px",
                        borderRadius: "8px",
                        overflowY: "auto",
