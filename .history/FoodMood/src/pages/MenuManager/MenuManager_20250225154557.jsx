...
const MenuManager = () => {
    ...
    return (
        <>
            {/* Desktop Mode */}
            {!isMobile && (
                <Box sx={{ backgroundColor: "#fff", width: "70%", height: "100vh", padding: "20px", borderRadius: "8px", overflowY: "auto", marginRight: "10px" }}>
                    <MenuList
                        data={data}
                        category={category}
                ...
                {/* แสดง AddMenu และ MenuItemDetail ด้วย Box โดยจะอย๔ู่ทางด้านขวามือ  */}
                (showEditData || showItemDetail) && (
                    <Box sx={{ backgroundColor: "#fff", width: "30%", height: "100vh", padding: "20px", borderRadius: "8px", overflowY: "auto", display: "flex", flexDirection: "column" }}>
                        {showEditData && (
                            <AddNewMenu
            ...
            {/* Mobile Mode - ใช้ Modal */}
            {isMobile && (
                <Modal open={showEditData || showItemDetail} onClose={() => { setShowEditData(false); setShowItemDetail(false); }}>
                    <Box sx={{ backgroundColor: "#fff", padding: "20px", borderRadius: "8px", maxWidth: "90vw", height: "80vh", margin: "10vh auto", overflowY: "auto", display: "flex", flexDirection: "column" }}>
                        {showEditData && (
                            <AddNewMenu
                                form={isEditing ? "Edit" : "Add"}
                                dataToEdit={dataToEdit}
