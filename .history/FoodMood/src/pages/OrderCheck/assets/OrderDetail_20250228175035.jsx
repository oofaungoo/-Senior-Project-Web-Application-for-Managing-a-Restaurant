...
const OrderDetail = ({ selectedOrder, onClose, updateOrder }) => {
    ...
    return (
        <>
            ...
            <div className="filter-bubble-container" style={{ height: "500px",marginTop: "10px", paddingBottom: "12px", overflowX: "auto", whiteSpace: "nowrap", marginBottom: 0 }}>
