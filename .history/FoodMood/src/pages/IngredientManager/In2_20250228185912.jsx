...
const IngredientManager = () => {
    ...
    useEffect(() => {
        ...
        //    .then(
        //        res => setIngredientCategory(res.data),
        //        console.log("มาแล้วครับ มาแล้ว",ingredientCategory)
        //    )
        //    .catch(err => console.error('Error fetching ingredients:', err));
    ...
    // Filter function
    const filteredIngredients = data.filter(name =>
        name.toLowerCase().includes(search) &&
        (categoryFilter ? name.category === categoryFilter : true)
    );
