...
const AddIngredient = ({ data, onClose, onSave, isEditing }) => {
    ...
    const [showAlert, setShowAlert] = useState(false); // ✅ State สำหรับ Alert
    ...
    const handleSave = () => {
        ...
        // ✅ แสดง Alert และซ่อนหลัง 3 วินาที
        setShowAlert(true);
    ...
    return (
        <>
            {/* ✅ Alert Message */}
            {showAlert && <Alert severity="success">บันทึกข้อมูลสำเร็จ!</Alert>}
