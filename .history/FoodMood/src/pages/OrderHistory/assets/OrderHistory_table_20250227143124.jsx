...
const OrderHistory_table = ({ data = [] }) => {
    ...
    const columns = [
        ...
        { field: 'totalPrice', headerName: 'ราคา', type: 'number', width: 140, flex:1, align: 'left' },
        ...
        { field: 'actions', headerName: '', type: 'number', align: 'left', width: 150, flex:1, sortable: false,
            renderCell: (params) => (
                <>
