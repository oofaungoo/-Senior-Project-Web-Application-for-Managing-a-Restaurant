                ...
                <Grid container spacing={1} sx={{ display: "flex", alignItems: "center", marginBottom: "8px", paddingBottom: "8px", borderBottom: "1px solid #ddd" }}>
                    ...
                    <Grid item xs={10} sx={{ display: "flex", justifyContent: "flex-end", flexWrap: "wrap", gap: "8px" }}>
                        ...
                        <button
                            ...
                            disabled={ingredientList.some((acc, index) => (acc.newIngredientQty * (quantity + 1)) > ingredientRemainList[index].remain)}
                        >
                            +
                        </button>
                    </Grid>
                    {/* แสดงข้อความ "วัตถุดิบไม่เพียงพอ" ถ้าวัตถุดิบติดลบ */}
                    {ingredientList.some((acc, index) => (acc.newIngredientQty * quantity) > ingredientRemainList[index].remain) && (
                        <Grid item xs={12} sx={{ textAlign: "center", marginTop: "4px" }}>
                            <p style={{ color: "red", fontSize: "14px" }}>วัตถุดิบไม่เพียงพอ</p>
                        </Grid>
                    )}
                </Grid>
