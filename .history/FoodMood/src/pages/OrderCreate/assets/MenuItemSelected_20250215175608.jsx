                            ...
                            <Grid key={index} item xs={12} style={{paddingLeft: '10%'}}>
                               <Grid container justifyContent={'space-between'}>
                                    ...
                                    <Grid item xs={5} display={'flex'} justifyContent={'flex-end'} style={{paddingRight: '5%'}}>
                                        <p>{(acc.newIngredientQty*quantity).toFixed(0)}/</p><p style={{color:(acc.newIngredientQty*quantity)>ingredientRemainList[index].remain ?"red":"black" }}>{ingredientRemainList[index].remain}</p>
                                    </Grid>
                                    <Grid item xs={1}>
                                        <p>{acc.unit}</p>
                                    </Grid>
