        ...
        <Stack sx={{ minHeight: "100%", display: "flex" }}>
            ...
            <Grid sx={{ flexGrow: 1 }}>
                ...
                {Array.isArray(selectedItem?.customOptions) && selectedItem.customOptions.length > 0 && (
                    <Grid container spacing={1} sx={{ display: "flex", alignItems: "center", marginTop: "8px", paddingBottom: "8px", borderBottom: "1px solid #ddd" }}>
                        {selectedItem.customOptions.map((customOption) => (
                            <Grid key={customOption._id} sx={{ marginBottom: "8px" }}> {/* ✅ เพิ่มระยะห่างแต่ละ option */}
                                ...
                                <div className="option-box-container" style={{ display: "flex", flexWrap: "wrap", gap: "8px" }}> {/* ✅ ให้ option เว้นระยะห่าง */}
