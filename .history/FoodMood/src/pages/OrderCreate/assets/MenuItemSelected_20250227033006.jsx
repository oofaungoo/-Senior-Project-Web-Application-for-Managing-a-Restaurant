        ...
        <Stack sx={{ minHeight: "100%", display: "flex" }}>
            ...
            <Grid sx={{ flexGrow: 1 }}>
                ...
                <Grid>
                    ...
                    <input type="text" value={note} onChange={(e) => setNote(e.target.value)} placeholder="เช่น ไม่ใส่ถั่ว ไม่เอาผัก" style={{width: "100%", resize:"vertical", border: "1px solid #ccc", borderRadius: "4px"}}/>
                </Grid>
            </Grid>
