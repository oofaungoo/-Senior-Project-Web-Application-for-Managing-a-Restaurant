        ...
        <Stack sx={{ minHeight: "100%", display: "flex" }}>
            ...
            <Grid sx={{ flexGrow: 1 }}>
                ...
                <Grid container spacing={1} sx={{ display: "flex", alignItems: "center", marginBottom: "8px", paddingBottom: "8px", borderBottom: "1px solid #ddd" }}>
                    ...
                    <Grid item xs={10} sx={{ display: "flex", justifyContent: "flex-end", flexWrap: "wrap", gap: "8px"}}>
                    {/* <Grid item xs={10} sx={{ display: "flex", justifyContent: "flex-end", flexWrap: "wrap", gap: "8px" }}>
                        <RemoveCircleIcon onClick={handleQuantityDecrease} disabled={quantity === 1} sx={{fontSize:"36px", color:"#64A2FF", marginRight:"8px"}}/>
                        <span>{quantity}</span>
                        <AddCircleIcon onClick={handleQuantityIncrease} sx={{fontSize:"36px", color:"#64A2FF", marginLeft:"8px"}}/>
                    </Grid> */}
                    </Grid>
