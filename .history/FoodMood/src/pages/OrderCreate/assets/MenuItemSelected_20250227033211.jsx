        ...
        <Stack sx={{ minHeight: "100%", display: "flex" }}>
            ...
            <Grid sx={{ flexGrow: 1 }}>
                ...
                <Grid>
                    ...
                    <textarea type="text" value={note} onChange={(e) => setNote(e.target.value)} placeholder="เช่น ไม่ใส่ถั่ว ไม่เอาผัก" style={{width: "100%", height: "60px", minHeight: "60px", resize: "vertical",  border: "1px solid #ccc",borderRadius: "4px", padding: "8px", fontSize: "16px" }}/>
                </Grid>
            </Grid>
