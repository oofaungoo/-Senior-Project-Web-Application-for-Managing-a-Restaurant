        ...
        <Stack sx={{ minHeight: "100%", display: "flex" }}>
            ...
            <Grid sx={{ flexGrow: 1 }}>
                ...
                <Grid>
                    ...
                    <input type="text" value={note} onChange={(e) => setNote(e.target.value)} placeholder="เช่น ไม่ใส่ถั่ว ไม่เอาผัก" style={{
            width: "100%",   // ✅ ทำให้ input ขยายเต็ม Grid
            padding: "8px",  // ✅ เพิ่ม padding ให้พิมพ์ง่ายขึ้น
            border: "1px solid #ccc",  // ✅ ขอบ input ดูชัดขึ้น
            borderRadius: "4px"  // ✅ มุมโค้งเล็กน้อยให้ดูสวย
        }}/>
                </Grid>
            </Grid>
